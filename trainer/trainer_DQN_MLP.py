...
class DQNAgent:
    ...
    """
    def __init__(self, input_size, output_size, gamma=0.99, epsilon_start=1.0, epsilon_final=0.1, epsilon_decay=200):
        ...
        # 初始化网络和优化器
        self.policy_net = DQN(input_size, output_size).cuda()  # 使用GPU训练
        self.target_net = DQN(input_size, output_size).cuda()
...
if __name__ == "__main__":
    ...
    # 训练 DQN 智能体
    num_episodes:int = 100000  # 训练总轮数，每次训练前记得修改
    ...
    path = f"{base_path}dqn_model_{formatted_time}.pth"
